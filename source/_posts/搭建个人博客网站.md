...
> 5. 自定义域名的作用是，在上传图片成功后，PicGo会将"自定义域名+上传的图片名"生成的访问链接放到剪切板：https://raw.githubusercontent.com/用户名/RepositoryName/分支名或者使用cdn加速：https://cdn.jsdelivr.net/gh/用户名/RepositoryName来加速
